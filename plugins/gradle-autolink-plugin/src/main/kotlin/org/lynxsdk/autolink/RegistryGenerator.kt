...
class RegistryGenerator {
    ...
    fun generateAndroidRegistry(
        ...
        outputDir: File,
        packageName: String = "com.lynx.autolink.generated"
    ) {
        ...
        val registryCode = buildString {
            ...
            appendLine("/**")
            appendLine(" * Auto-generated registry for Lynx extensions")
            appendLine(" * Generated by Lynx Autolink Gradle Plugin v0.0.1")
            appendLine(" * ")
            ...
            appendLine()
            appendLine("    /**")
            appendLine("     * Registers all discovered Lynx extensions with the application")
